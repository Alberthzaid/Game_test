...
class Player(pygame.sprite.Sprite):
	def __init__(self):
		super().__init__()
		self.image = pygame.image.load("assets/Player-01.png").convert()
...
def show_go_screen():
	...
	draw_text(screen, "STAR SHOOTER", 65, WIDTH // 2, HEIGHT // 4)
	draw_text(screen, "Instruciones : Mueve con las flechas y ataca con espacio. Evita chocar", 27, WIDTH // 2, HEIGHT // 2)
